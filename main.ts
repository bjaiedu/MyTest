...
let lastGetureValue = APDS9960.Direction_type.DIR_NONE;
let apds = new APDS9960.apds9960();

//% blockId="SET_GESTURE_INIT" block="初始化手势传感器"
//% weight=100 blockGap=1
function Init_apds9960() {
...
function onGesture(gesture: APDS9960.Direction_type, handler: Action) {
